...
services:
  ...
  quasar-updater:
    ...
    environment:
      ...
      QUASAR_UPDATER_SIGNATURE_MODE: ${QUASAR_UPDATER_SIGNATURE_MODE:-}
      QUASAR_UPDATER_TRUSTED_KEYS: ${QUASAR_UPDATER_TRUSTED_KEYS:-}
      QUASAR_UPDATER_MANIFEST_BASE_URL: ${QUASAR_UPDATER_MANIFEST_BASE_URL:-}
      QUASAR_UPDATER_MANIFEST_TIMEOUT_S: ${QUASAR_UPDATER_MANIFEST_TIMEOUT_S:-}
    volumes:
