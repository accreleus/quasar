// Static lookup tables for the input protocol (protocol/input.md — FROZEN).
// KeyboardEvent.code → Linux evdev keycode (linux/input-event-codes.h).
// Mouse button index → Linux BTN_* code (BTN_LEFT=0x110, BTN_RIGHT=0x111, BTN_MIDDLE=0x112).
...
// Browser MouseEvent.button → Linux BTN_* evdev code.
export const MB_MAP: Record<number, number> = {
  0: 272, // BTN_LEFT
  2: 273, // BTN_RIGHT
  1: 274, // BTN_MIDDLE
};
