...
bring-up write-up, `docs/design/research/2026-08-18-benchapp-bringup.md`, which was deliberately not carried over to the public repository). Decoding in the
...
A 2026-08-19 report (`docs/reports/2026-08-19-latency-budget/REPORT.md`, which was deliberately not carried over to the public repository)
...
- **Never** to make a run that regressed for an unknown reason quietly green. Find out why first (`quasar-diagnose`, the stage table itself; section 6 of that same report had the known-actionable levers, but the report was deliberately not carried over to the public repository).
