...
`docs/completed/phase4/`, which was deliberately not carried over to the public repository
(commit `590abb4`) and is not public — see the compact verdict in
...
swap, not a re-model). Complete — the execution record (`docs/completed/phase5/`) was deliberately not carried over to the public repository, not lost from
...
`docs/phase6/`; that path does not exist in this repo (deliberately not carried over to the public repository) — this paragraph is the current scope record.
...
that path does not exist in this repo (deliberately not carried over to the public repository,
...
not exist in this repo (deliberately not carried over to the public repository) —
...
does not exist in this repo (deliberately not carried over to the public repository, commit
`590abb4`) and is not public — this paragraph is the current scope record.
