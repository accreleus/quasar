...
§D1/§D2, did not survive the public-release history squash). Take effect when `abr_ladder_resolution` is on — and, because the **fps** rung shares this
...
which did not survive the public-release history squash).
...
write-up, `docs/reports/2026-08-22-vulkanscale-validation/H265-PROFILE-CAPS.md`, did not
survive the public-release history squash). On an
...
`docs/superpowers/specs/2026-08-16-adaptive-external-resolution-design.md`, did not
survive the public-release history squash.
