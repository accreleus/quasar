...
| # | result | message |
| --- | --- | --- |
| preflight | pass | preflight: engine clear (foreign_quasar_projects=0, port 18080 free, /var/lib/rh02h-c57f6ce6 free) |
...
| seed | pass | seed: app 'rh02h-c57f6ce6: app-nohome' ready (80d7b1fa-66d3-4c55-83bb-bc96ad0982e2) |
| seed | pass | seed: app 'rh02h-c57f6ce6: app-home' ready (6a049417-f91f-4dfd-9303-f6e103488aa7) |
...
| 9 | pass | 9: host row rh02h-c57f6ce6-real deleted 204 |
| 9 | pass | 9: ownership cleanup — zero labelled containers/volumes/networks, /var/lib/rh02h-c57f6ce6 gone |
