...
| # | result | message |
| --- | --- | --- |
| preflight | pass | preflight: engine clear (foreign_quasar_projects=0, port 18080 free, /var/lib/rh02h-ce0d04cd free) |
...
| seed | pass | seed: app 'rh02h-ce0d04cd: app-nohome' ready (c7f7d2c0-eb24-4613-9645-870c08f32a1f) |
| seed | pass | seed: app 'rh02h-ce0d04cd: app-home' ready (46cd6550-b202-456f-82b9-7afe96074227) |
...
| 9 | pass | 9: host row rh02h-ce0d04cd-real deleted 204 |
| 9 | pass | 9: no entry under /run/quasar-agent that was not there at preflight (after removing harness-attributable leftovers) |
| 9 | pass | 9: ownership cleanup — zero labelled containers/volumes/networks, /var/lib/rh02h-ce0d04cd gone |
