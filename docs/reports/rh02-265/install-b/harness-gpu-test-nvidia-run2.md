...
| # | result | message |
| --- | --- | --- |
| preflight | pass | preflight: engine clear (foreign_quasar_projects=0, port 18080 free, /var/lib/rh02h-33073a71 free) |
...
| seed | pass | seed: app 'rh02h-33073a71: app-nohome' ready (<uuid>) |
| seed | pass | seed: app 'rh02h-33073a71: app-home' ready (<uuid>) |
...
| 9 | pass | 9: host row rh02h-33073a71-real deleted 204 |
| 9 | pass | 9: ownership cleanup — zero labelled containers/volumes/networks, /var/lib/rh02h-33073a71 gone |
