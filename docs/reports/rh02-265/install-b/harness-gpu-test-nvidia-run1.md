...
| # | result | message |
| --- | --- | --- |
| preflight | pass | preflight: engine clear (foreign_quasar_projects=0, port 18080 free, /var/lib/rh02h-25601c34 free) |
...
| seed | pass | seed: app 'rh02h-25601c34: app-nohome' ready (<uuid>) |
| seed | pass | seed: app 'rh02h-25601c34: app-home' ready (<uuid>) |
| baseline | pass | baseline: input_probe passes before any fault |
| baseline | pass | baseline: audio_probe passes before any fault |
| baseline | fail | baseline: launch did not reach running within 90s — {"state":"failed","state_detail":"preparing resources and image","error_message":"start source pipeline: source pipeline failed to reach PLAYING: Element failed to change its state","failure_code":null} |
...
| 9 | pass | 9: host row rh02h-25601c34-real deleted 204 |
| 9 | pass | 9: ownership cleanup — zero labelled containers/volumes/networks, /var/lib/rh02h-25601c34 gone |
