...
| # | result | message |
| --- | --- | --- |
| preflight | pass | preflight: engine clear (foreign_quasar_projects=0, port 18080 free, /var/lib/rh02h-4b8b95b0 free) |
...
| seed | pass | seed: app 'rh02h-4b8b95b0: app-nohome' ready (<uuid>) |
| seed | pass | seed: app 'rh02h-4b8b95b0: app-home' ready (<uuid>) |
...
| 9 | pass | 9: host row rh02h-4b8b95b0-real deleted 204 |
| 9 | pass | 9: ownership cleanup — zero labelled containers/volumes/networks, /var/lib/rh02h-4b8b95b0 gone |
