...
which did not survive the public-release history squash and is not recoverable from this
...
correspond to were at `docs/reports/2026-07-26-gwd-upstream-submission-drafts.md`, which did not
survive the public-release history squash; check the PRs themselves upstream for current status.
